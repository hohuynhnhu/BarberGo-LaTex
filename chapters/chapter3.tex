...
\end{tabular}
\end{table}
\subsection{Sơ đồ use case chi tiết về xử lý người dùng đặt lịch}
%----------------------------------------------------------------booking---------------
\begin{figure}[H]
    \centering
...
\end{tabular}
\end{table}
\subsection{Sơ đồ use case chi tiết về người dùng sử dụng dịch vụ AI}
%----------------------------------------------------------------AI---------------
\begin{figure}[H]
    \centering
...
\end{table}
%----------------------------------------------------------------Tiệm tóc quản lý---------------
\subsection{Sơ đồ use case chi tiết về tiệm tóc quản lý}
\begin{figure}[H]
    \centering
...
\end{table}
%----------------------------------------------------------------Hợp tác---------------
\subsection{Sơ đồ use case chi tiết về đăng ký hợp tác}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/usecase_hoptac.jpg}
    \caption{Sơ đồ use case đăng ký hợp tác}
...
%----------------------------------------------------------------Admin---------------
\subsection{Sơ đồ use case chi tiết về admin quản lý hệ thống}
\begin{figure}[H]
    \centering
...
\subsection{Sơ đồ use case chi tiết về xử lý thông báo}

%---------------------------------------------------------------Thông báo---------------
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/usecase_thongbao.jpg}
    \caption{Sơ đồ use case xử lý thông báo}

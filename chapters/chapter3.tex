...
\begin{table}[H]
\centering
\caption{Đặc tả Use Case UC-10: Xem chi tiết tiệm tóc}
\label{tab:uc10}
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Actor} & Customer \\
...
\begin{table}[H]
\centering
\caption{Đặc tả Use Case UC-11: Tìm kiếm tiệm tóc}
\label{tab:uc11}
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Actor} & Customer \\
...
2. Extend: Xem danh sách tiệm tóc \newline
...
\begin{table}[H]
\centering
\caption{Đặc tả Use Case UC-12: Tạo tiệm tóc}
\label{tab:uc12}
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Actor} & Admin \\
...
\include{chapters/chapter3/sequence}
\include{chapters/chapter3/baomat}
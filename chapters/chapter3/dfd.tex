...
\begin{itemize}
    ...
    \item \textbf{2.0 Quản lý Barber:} Quản lý thông tin tiệm tóc, dịch vụ và giờ làm việc
...
\begin{itemize}
    ...
    \item \textbf{D2: Barbers} - Thông tin tiệm tóc
...
DFD cấp 1 cho module Quản lý Barber chi tiết hóa các tiến trình liên quan đến quản lý thông tin tiệm tóc và dịch vụ.
...
Các tiến trình con:
\begin{itemize}
    \item \textbf{2.1 Tìm kiếm \& Xem Barber:} Khách hàng tìm kiếm tiệm tóc theo khu vực, tên hoặc xếp hạng. Tiến trình truy vấn D2: Barbers và D6: Ratings để trả về kết quả phù hợp

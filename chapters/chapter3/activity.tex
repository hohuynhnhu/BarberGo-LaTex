...
\textbf{Mục đích:} Cho phép người dùng đăng ký trở thành chủ tiệm tóc thông qua quy trình xét duyệt từ Admin, bao gồm xác thực thông tin và phê duyệt hồ sơ.
...
\begin{itemize}
    ...
    \item Người dùng:
    \begin{itemize}
        \item Nhập ảnh chụp vị trí
        \item Thiết lập giờ làm việc
        \item Thiết lập thông tin hệ thống
...
\subsection{Activity Diagram tra cứu tiệm tóc}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/ac_tra_cuu.jpg}
    \caption{Activity Diagram tra cứu tiệm tóc}
    \label{fig:ac_tra_cuu}
\end{figure}
\textbf{Mục đích:} Cho phép người dùng tìm kiếm và tra cứu thông tin các tiệm tóc theo tên hoặc theo các tiêu chí lọc.
...
\subsection{Activity Diagram cập nhật thông tin tiệm tóc}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth]{figures/ac_update_ower.jpg}
    \caption{Activity Diagram cập nhật thông tin tiệm tóc}
    \label{fig:ac_update_ower}
\end{figure}


\textbf{Mục đích:} Cho phép Barber Owner chỉnh sửa và cập nhật thông tin tiệm tóc của mình trong hệ thống.

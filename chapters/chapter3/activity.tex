...
\subsection{Sơ đồ activity xử lý đăng ký}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/ac_dk.jpg}
    \caption{Sơ đồ activity xử lý đăng ký}
    \label{fig:ac_dk}
\end{figure}
...
\begin{itemize}
    \item Khách hàng nhập thông tin đăng ký (Email, Mật khẩu, Họ tên, SĐT).
...
\subsection{Sơ đồ activity xử lý đăng nhập}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/ac_dn.jpg}
    \caption{Sơ đồ activity xử lý đăng nhập}
    \label{fig:ac_dn}
\end{figure}
...
\subsection{Sơ đồ activity xử lý đặt lịch}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/ac_booking.jpg}
    \caption{Sơ đồ activity xử lý đặt lịch}
...
\subsection{Sơ đồ activity xử lý AI gợi ý kiểu tóc}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_hair.jpg}
    \caption{Sơ đồ activity xử lý AI gợi ý kiểu tóc}
    \label{fig:ac_hair}
\end{figure}
...
\subsection{Sơ đồ activity xử lý AI kiểm tra da mặt}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_mun.jpg}
    \caption{Sơ đồ activity xử lý AI kiểm tra da mặt}
    \label{fig:ac_mun}
\end{figure}
...
\subsection{Sơ đồ activity xử lý AI chatbot}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/ac_tu_van.jpg}
    \caption{Sơ đồ activity xử lý AI chatbot}
    \label{fig:ac_chat}
\end{figure}
...
\subsection{Sơ đồ activity xử lý hợp tác}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_hoptac_ok.jpg}
    \caption{Sơ đồ activity xử lý hợp tác}
    \label{fig:ac_hoptac}
\end{figure}
\subsection{Đăng ký trở thành Barber Owner (Có phỉ duyệt)}
...
\subsection{Sơ đồ activity cập nhật thông tin cá nhân người dùng}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_update_profile.jpg}
    \caption{Sơ đồ activity cập nhật thông tin cá nhân}
...
\subsection{Sơ đồ activity tra cứu tiệm cắt tóc}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/ac_tra_cuu.jpg}
    \caption{Sơ đồ activity tra cứu tiệm cắt tóc}
...
\subsection{Sơ đồ activity cập nhật thông tin tiệm cắt tóc}
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth]{figures/ac_update_ower.jpg}
    \caption{Sơ đồ activity cập nhật thông tin tiệm cắt tóc}
...
\subsection{Sơ đồ activity xem tài liệu RAG}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_rag.jpg}
    \caption{Sơ đồ activity xem tài liệu RAG}
    \label{fig:xem_rag}
\end{figure}
...
\subsection{Sơ đồ activity tạo vector database}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_vecto_database.jpg}
    \caption{Sơ đồ activity tạo vector database}
...
\subsection{Sơ đồ activity cập nhật tài liệu RAG}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_update_rag.jpg}
    \caption{Sơ đồ activity cập nhật tài liệu RAG}
...
\subsection{Sơ đồ activity xóa tài liệu RAG}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/ac_xoa_rag.jpg}
    \caption{Sơ đồ activity xóa tài liệu RAG}
